...
<form action="http://localhost:8080/ProjetJee/nouveauMdp" method="post">
	...
	<div class="newMdp">
		<label for="newMdp">Nouveau mot de passe :  </label>
  		...
  		<input type="password" id="confirmation" name="confirmation" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{12,}$" title="Doit contenir au moins une lettre majuscule,une minsculeet au moins un chiffre, un caractère spécial et au minimum 12 caractères">
