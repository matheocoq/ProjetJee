...
<div class="row mx-3 mb-4">
	<div class="col-1" style="max-width: 100px" >
		<a class="text-decoration-none text-dark fw-bold" href="javascript:history.back()" ><span class="iconify" data-icon="ic:outline-keyboard-return"></span> Retour</a>
	</div>
	<div class="col-1">
		<a class="text-decoration-none text-dark fw-bold" href="javascript:location.reload()" ><span class="iconify" data-icon="ci:refresh"></span> Rafraîchir</a>
	</div>
</div>
